...
var (
	iranRedirectAddr = "10.10.34.34:80"
	http403          = []byte("HTTP/1.1 403 Forbidden")
	iranIFrame       = []byte(`<iframe src="http://10.10.34.34`)
)

// TODO: right now, the defaultDetector uses Iranian detection rules, should
// allow configuring this based on the detected country
