...
import (
	...
	chainedconfig "github.com/getlantern/flashlight/client/chained"
	frontedconfig "github.com/getlantern/flashlight/client/fronted"
...
type ByHost []*frontedconfig.FrontedServerInfo
