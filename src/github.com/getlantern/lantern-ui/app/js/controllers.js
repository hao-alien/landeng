...
app.controller('ProxiedSitesCtrl', [
  '$rootScope',
  '$scope',
  '$filter',
  'SETTING',
  ...
  'MODAL',
  'ProxiedSites',
  function($rootScope, $scope, $filter, SETTING, INTERACTION, INPUT_PAT, MODAL, ProxiedSites) {
...
app.controller('BuyProCtrl', [
  '$scope',
  '$timeout',
  'StripeCheckout',
  'STRIPE_PUB_KEY','PRO_API',
  'MODAL',
  function($scope, $timeout, StripeCheckout, STRIPE_PUB_KEY, PRO_API, MODAL) {
    $scope.show = false;
